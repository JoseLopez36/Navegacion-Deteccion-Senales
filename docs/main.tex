...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{media/0313-1_2400_imagen.jpg}
        \caption{Imagen ejemplo del dataset.}
        \label{fig:dataset_image}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{media/0313-1_2400_mask.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{media/resultadoEpocasCarril.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{media/prediccionRecto.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{media/prediccionCurvaLigera.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{media/resultados_carril.jpg}
...
Cuanto a la detección de las señales, se utiliza el modulo \textit{OpenCV} de python para tratar las imagenes. En esta sección se descomponen los diferentes
...
En esta parte, se tratarán de l arquitectura CNN del modelo así como los datasets utilizados para entrenarlo y validarlo. Se analizarán los resultados
...
A ver si es mejor poner esta parte al final de la parte 4.
